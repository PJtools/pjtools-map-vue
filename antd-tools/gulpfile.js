...
function tag() {
  ...
  execSync(`git push https://${process.env.GITHUB_TOKEN}@github.com/PJtools/pjtools-map-vue.git ${version}:${version}`);
  execSync(`git push https://${process.env.GITHUB_TOKEN}@github.com/PJtools/pjtools-map-vue.git master:master`);
  console.log('tagged');
}
