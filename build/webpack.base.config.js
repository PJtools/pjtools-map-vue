...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      pjmap: path.join(__dirname, '../components'),
      'pjtools-map-vue': path.join(__dirname, '../components'),
      'pjtools-map-vue/es': path.join(__dirname, '../components'),
      'pjtools-map-vue/lib': path.join(__dirname, '../components'),
      '@': path.join(__dirname, '../'),
    },
  },
