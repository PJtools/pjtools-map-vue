...
export default function render() {
  ...
  console.log(mode, store.isModeChangeRender);
  console.log('更新队列', changedIds);
  console.log('选中队列', selectedIds);
  ...
  console.log('全数据源：', newSources);
  console.log('更新数据：', renderList);
